...
const Upload = () => {
    ...
    const canNavigateToStep = (targetStep) => {
        ...
        if (targetStep === 2) return formData.videoFile !== null || uploadedVideoId !== null;
        if (targetStep === 3) return (formData.videoFile !== null && processingProgress === 100) || uploadedVideoId !== null;
        return false;
    };
    ...
    return (
        <div className="min-h-screen bg-[#0f0f0f] text-white pt-10 pb-12 font-sans selection:bg-[#e50914] selection:text-white flex items-center justify-center p-4">
            <div className="relative w-full max-w-5xl max-h-[85vh] mx-auto bg-gradient-to-br from-[#1a1a1a] to-[#251010] rounded-3xl border border-red-900/30 shadow-2xl shadow-black/90 flex flex-col overflow-hidden ring-1 ring-white/5 mt-16">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {currentStep === 3 && (
                            <motion.div key="step3" variants={pageVariants} initial="initial" animate="animate" exit="exit" className="w-full">
                                <div className="text-center mb-10"><h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Select a Thumbnail</h2><p className="text-gray-400 text-lg">Choose a frame that best represents your video.</p><div className="w-1 h-1 bg-[#e50914] mx-auto mt-6 rounded-full shadow-[0_0_10px_#e50914]" /></div>
