        ...
        <Link to={`/video/${video.id}`}>
            ...
            >
                <div className="relative aspect-video rounded-xl overflow-hidden mb-3">
                    ...
                    />
                    <div className="absolute bottom-2 right-2 bg-black/80 text-white text-[9px] font-bold px-1 py-0.5 rounded">
                ...
                <div className="flex gap-2.5">
                    ...
                    <div>
                        ...
                        <p className="text-white/40 text-[11px] mt-0.5 hover:text-white/60 transition-colors">
...
const VideoGrid = ({ videos, loading }) => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-10">
            {videos.map((video) => (
                <VideoCard key={video.uniqueKey || video.id} video={video} />
            ))}
        </div>
    );
};
