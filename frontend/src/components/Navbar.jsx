                ...
                <div className="flex items-center gap-4 sm:gap-8">
                    <Link to="/" className="flex items-center gap-2 group">
                        <motion.div
                            ...
                            className="w-8 h-8 sm:w-10 sm:h-10 bg-primary rounded-xl flex items-center justify-center font-black text-xl sm:text-2xl text-white italic shadow-lg shadow-primary/20"
                        >
                            u
                        </motion.div>
                        <span className="text-xl sm:text-2xl font-black tracking-tighter hidden xs:block">uTube</span>
                    </Link>
                </div>
